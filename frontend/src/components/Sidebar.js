...
const navItems = [
    ...
    { name: 'Maintenance PartUsed', path: '/maintenance/parts-used', icon: <FileText className="w-4 h-4" /> },
    { name: 'Maintenance Reading', path: '/maintenance/readings', icon: <FileText className="w-4 h-4" /> },
